...
public class BarcodeScanner extends Plugin implements BarcodeCallback {
    ...
    public void barcodeResult(BarcodeResult barcodeResult) {
        ...
        Log.d("scanner", "Scanned text: " + barcodeResult.getText());
        ...
        if (getSavedCall().hasOption("gif")) {
            notifyListeners("scannedResult", jsObject);
        } else {
    ...
    @PluginMethod
    public void startScanGif(PluginCall call) {
        saveCall(call);
        scan();
    }
